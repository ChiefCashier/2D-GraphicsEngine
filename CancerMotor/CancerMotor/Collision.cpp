...
{ 
	bool Collision::CollisionRectangle(CMShape* r1, CMShape* r2)
	{
		...
		{
			if (r1->GetX() - r1->GetOrigon().getX() <= r2->GetX() - r2->GetOrigon().getX())
			{
				if (r2->GetX() - r2->GetOrigon().getX() <= (r1->GetX() - r1->GetOrigon().getX() + r1->GetWidth()))
				{
					if (r1->GetY() - r1->GetOrigon().getY() <= r2->GetY() - r2->GetOrigon().getY())
					{
						if (r2->GetY() - r2->GetOrigon().getY() <= (r1->GetY() - r1->GetOrigon().getY() + r1->GetHeight()))
						{
							return true;
						}
					}
			...
			else if (r1->GetX() - r1->GetOrigon().getX() <= r2->GetX() - r2->GetOrigon().getX() + r2->GetWidth())
			{
				if ((r2->GetX() - r2->GetOrigon().getX() + r2->GetWidth()) <= (r1->GetX() - r1->GetOrigon().getX() + r1->GetWidth()))
				{
					if (r1->GetY() - r1->GetOrigon().getY() <= r2->GetY() - r2->GetOrigon().getY() + r2->GetHeight())
					{
						if ((r2->GetY() - r2->GetOrigon().getY() + r2->GetHeight()) <= (r1->GetY() - r1->GetOrigon().getY() + r1->GetHeight()))
						{
							return true;
						}
					}
		...
		else 
		{
			if (r1->GetX() <= r2->GetX() <= r1->GetX() + r1->GetWidth() )
				if( r1->GetY() <= r2->GetY() <= r1->GetY() + r1->GetHeight() )
				{
					...
					float x1 = -r1->GetOrigon().getX() + r1->GetX() + std::cos(r1->GetRotation() * 3.141 / 180) * r1->GetWidth();
					float x2 = -r1->GetOrigon().getX() + r1->GetX() + std::cos(r1->GetRotation() * 3.141 / 180 + 3.141 / 2) * r1->GetHeight();
					float y1 = -r1->GetOrigon().getY() + r1->GetY() + std::sin(r1->GetRotation() * 3.141 / 180) * r1->GetWidth();
					float y2 = -r1->GetOrigon().getY() + r1->GetY() + std::sin(r1->GetRotation() * 3.141 / 180 + 3.141 / 2) * r1->GetHeight();


					float xt1 = -r2->GetOrigon().getX() + r2->GetX();
					float yt1 = -r2->GetOrigon().getY() + r2->GetY();


					float xdifference1 = std::cos(r2->GetRotation() * 3.141 / 180)* r2->GetWidth();
					float xt2 = -r2->GetOrigon().getX() + r2->GetX() + xdifference1;
					float ydifference1 = std::sin(r2->GetRotation() * 3.141 / 180) * r2->GetWidth();
					float yt2 = -r2->GetOrigon().getY() + r2->GetY() + ydifference1;


					float xdifference2 = std::cos(r2->GetRotation() * 3.141 / 180 + 3.141 / 2)* r2->GetHeight();
					float xt3 = -r2->GetOrigon().getX() + r2->GetX() + xdifference2;
					float ydifference2 = std::sin(r2->GetRotation() * 3.141 / 180 + 3.141 / 2) * r2->GetHeight();
					float yt3 = -r2->GetOrigon().getY() + r2->GetY() + ydifference2;
					
					

					float xt4 = -r2->GetOrigon().getX() + r2->GetX() + xdifference1 + xdifference2;
					float yt4 = -r2->GetOrigon().getY() + r2->GetY() + ydifference1 + ydifference2;
